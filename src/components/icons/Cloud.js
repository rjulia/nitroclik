...
const Cloud = ({ ...restProps }) => (
  <span {...restProps}>
    <svg xmlns="http://www.w3.org/2000/svg" id="cloud" x="0px" y="0px" viewBox="0 0 520 520"  width="52px" height="52px">
      <g>
        <g>
          <circle className="web___line--one" cx="101.55" cy="389.4" r="24.3"/>
          <circle className="web___line--one" cx="387.15" cy="389.4" r="24.3"/>
          <path className="web___line--one" d="M163.35,380.3h-29.8c-4-14-16.8-24.3-32.1-24.3c-18.4,0-33.3,15-33.3,33.3c0,18.4,15,33.3,33.3,33.3
          ...
          <path className="web___line--one" d="M298.05,297.5c-5,0-9.1,4.1-9.1,9.1v55.6c0,20,16.3,36.3,36.3,36.3h29.8c4,14,16.8,24.3,32.1,24.3
          ...
          <circle className="web___line--one" cx="244.35" cy="455.3" r="24.3"/>
          <path className="web___line--one" d="M254.25,0c-36.8,0-70.9,20.1-88.9,51.8c-3.7-0.8-7.4-1.1-11.3-1.1c-30.6,0-55.6,24.9-55.6,55.6c0,4.1,0.4,8.1,1.3,12.1
          ...
          <path className="web___line--one" d="M244.35,297.5c-5,0-9.1,4.1-9.1,9.1v116.7c-13.7,3.9-23.9,16.4-24.3,31.2c-0.2,8.9,3.1,17.4,9.2,23.8
