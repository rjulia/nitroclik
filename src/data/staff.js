export default [
  {
    ...
    bio: "Ramon is a web designer and developer born in Spanish, English and Spanish speaking, with more than two decades of experience, in multiple projects, with both disciplines, graphic design and software development. After working in an star-up, small and large companies in Spain and Hong Kong, this is the time to be part of a new team, eager to face new challenges. Passionate always by the learn something new every day, either to learn the latest technologies or Cantones."
  },
  {
    name: 'Jani Siivola',
  ...
  },
  {
    ...
    bio: 'Christy is a passionate graphic designer, web designer, photographer and graduated landscape architect. She has experience working in various media for on and offline projects and from concepts to visualisation, for print and digital. Having worked for clients such as Q Acoustics, Armour Asia, NL international, Number Life, Guru Acoustics and a whole host of familiar brands. She produces work that sits within project guidelines, balancing creativity with discipline and deliver deadlines.'
  }
]